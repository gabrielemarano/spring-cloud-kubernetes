package it.gmarano.microservices.user.controller;

import it.gmarano.microservices.model.Product;
import it.gmarano.microservices.model.User;
import it.gmarano.microservices.user.feign.ProductClient;
import it.gmarano.microservices.user.service.UserService;
